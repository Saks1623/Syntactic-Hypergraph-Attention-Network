...
parser.add_argument('--initialFeatureSize', type=int, default=768, help='initial size')
...
parser.add_argument('--use_syn',action='store_true',help='use Dependency to contruct syntactic hyperedge')
parser.add_argument('--use_bert',action='store_true',help='use BERT embedidngs')
...
def main():
	doc_content_list, doc_train_list, doc_test_list, vocab_dic, labels_dic, max_num_sentence, keywords_dic, syntactic_dic,class_weights = read_file(args.dataset, args.use_LDA,args.use_syn)
	...
	if args.use_bert:
		pre_trained_weight = loadBERTModel(vocab_dic, args.dataset)
	...
	train_data = Data(train_data, max_num_sentence, keywords_dic, syntactic_dic, num_categories, args.use_LDA,args.use_syn)
	valid_data = Data(valid_data, max_num_sentence, keywords_dic, syntactic_dic, num_categories, args.use_LDA,args.use_syn)
	test_data = Data(test_data, max_num_sentence,  keywords_dic, syntactic_dic, num_categories, args.use_LDA,args.use_syn)
